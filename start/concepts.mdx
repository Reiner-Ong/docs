...
<Steps>
  ...
  <Step title="Work Done">
    The technician has completed the on-site work and submitted their checklist or report. A jobsheet (record) is automatically created. The Building Manager receives a signing request by email and SMS.
  </Step>
  <Step title="Signed">
